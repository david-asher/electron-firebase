...
function setupAppConfig()
{
    ...
    {
        var content = null
        const testFileName = `${projectRoot}/developer/${filename}.json`
...
function openSplash()
{
    if ( !global.appConfig.webapp.splashPage ) return
...
async function startMainApp( options )
{
    ...
    try {
        ...
        // first show the splash, which should have no code dependencies
        openSplash()
