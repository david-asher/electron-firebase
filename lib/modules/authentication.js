...
function gcpApi( requestOptions )
{
    return new Promise( (resolve, reject) => {
        ...
        global.currentUser.getIdToken()
        .then( (token) => {

            console.log( "gcpApi token: ", token )
            console.log( "gcpApi gcOptions: ", gcOptions )
...
function signInNewUser( newUser )
{
    ...
    return new Promise((resolve, reject) => {
        ...
        var getToken = firebase.functions().httpsCallable('customToken')
...
{
    var loginUrl = `${global.appConfig.webapp.hostUrl}/${global.appConfig.webapp.login}`
    if ( bSignOutUser ) loginUrl += "?signoutuser=true"
