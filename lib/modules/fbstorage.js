...
class fileStore
{
    ...
    async find( filepath, queryMatch = "path" )
    {
        ...
        return this._newestDoc( querySnapshot.docs, "updated" ).data()
    }
    ...
    async update( filepath, metadata )
    {
        ...
        try {
            ...
            console.error( "update: ", filepath, metadata, error )
        }
        return metaResult
    }
    ...
    async download( filepath )
    {
        ...
        try {
            ...
            console.error( "download: ", filepath, error )
        }
        return result
    }
    ...
    async about( filepath )
    {
        ...
        try {
            ...
            console.error( "about: ", filepath, error )
        }
        return aboutFile
    }
