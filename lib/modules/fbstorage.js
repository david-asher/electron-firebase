...
class fileStore
{
    ...
    async _removeFolderDb( folderPath )
    {
        ...
        try {
            ...
            result = await this.root.remove( this._dbPath( folderListDoc), folderArray, folderPath )
        }
        catch (error) {
            console.error( "_removeFolderDb: ", folderPath )
        }
        return result
    }
    ...
    async _initFolderList()
    {
        ...
        try {
            ...
            result = await this.root.write( this._dbPath( folderListDoc ), updateMap )
        }
        catch (error) {
            console.error( "_initFolderList: ", this.name, error )
        }
        return result
    }
    ...
    async _deleteDocListDb( docList )
    {
        try {
            ...
            console.error( "_deleteDocListDb: ", docList, error )
        }
    }
    ...
    async _newestDoc( docList, compareField )
    {
        ...
        try {
            ...
            console.error( "_newestDoc: ", docList, compareField, error )
        }
        return result
    }
    ...
    async delete( filepath )
    {
        ...
        .catch( (error) => {
            console.error( "delete: ", filepath, error )
            return null
        })
        ...
        return await this._removeFolderDb( folder )
    }
}
...
async function initialize()
{
    try {
        ...
        console.error( "fbstorage initialize: ", error )
    }
}
