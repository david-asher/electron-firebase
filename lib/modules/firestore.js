...
class firestoreDoc
{
    ...
    async about( docPath, bGetFromServer = false )
    {
        ...
        try {
            ...
            if ( !docRef ) return result
            result = await docRef.get( this._fromServer( bGetFromServer ) ) || result
        }
        catch (error) {
    ...
    async write( docPath, contents = {} )
    {
        ...
        try {
            ...
            console.error( "write: ", docPath, error )
        }
        return result
    }
    ...
    async read( docPath, bGetFromServer = false )
    {
        ...
        try {
            ...
            console.error( "read: ", docPath, error )
        }
        return result
    }
    ...
    async field( docPath, fieldName, bGetFromServer = false )
    {
        ...
        try {
            ...
            console.error( "field: ", docPath, fieldName, error )
        }
        return result
    }
