...
const eachFileCollection    = "files"
 ...
 * * files - A Firestore subtree for the tracking the user's files in Firebase Storage
...
{
    fireSet[ eachFileCollection ] = new firestoreDoc( eachFileCollection, userid )
    ...
    module.exports.files  = fireSet[ eachFileCollection ]
