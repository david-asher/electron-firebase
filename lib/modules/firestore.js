...
class firestoreDoc
{
    ...
    _ref( docPath )
    {
        ...
        try {
            ...
            docRef = collectionRef.doc( 0 === ( nParts % 2 ) ? docName : "" ) || result
        }
        catch (error) {
    ...
    about( docPath, bGetFromServer = false )
    {
        ...
        try {
            ...
            result = docRef.get( this._fromServer( bGetFromServer ) ) || result
        }
        catch (error) {
    ...
    async read( docPath, bGetFromServer = false )
    {
        ...
        try {
            ...
            result = await snap.data( getSnaphotOptions ) || result
        }
        catch( error ) {
    ...
    async find( collectionPath, fieldName, fieldMatch, matchOperator = "==" )
    {
        ...
        try {
            ...
            result = collectionRef.where( fieldName, matchOperator, fieldMatch ).get() || result
        }
        catch (error) {
