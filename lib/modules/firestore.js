...
const forEachUser   = "users"
const forEachApp    = "apps"
const forAllApps    = "global"
 ...
 * * users - A Firestore subtree for the signed-in user's documents in Firestore
 * * apps - A Firestore subtree for the app being used, accessible to all users
 *  
...
{
    fireSet[ forEachUser ] = new firestoreDoc( forEachUser, userid )
    fireSet[ forEachApp ]  = new firestoreDoc( forEachApp, appid )
    fireSet[ forAllApps ]  = new firestoreDoc( forEachApp, forAllApps )

    module.exports.doc    = fireSet[ forEachUser ]
    module.exports.app    = fireSet[ forEachApp ]
    module.exports.global = fireSet[ forAllApps ]
